...
<pdfrx-viewer
  ...
  wasm-modules-url="https://cdn.jsdelivr.net/npm/@pdfrx/engine@0.16.0/assets/"
...
const viewer = new PdfrxViewer(document.getElementById('container')!, {
  engineOptions: {
    wasmModulesUrl: 'https://cdn.jsdelivr.net/npm/@pdfrx/engine@0.16.0/assets/',
  },
});
