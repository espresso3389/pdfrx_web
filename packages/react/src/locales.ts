...
const ja: Partial<PdfrxStrings> = {
  ...
  spreadNone: '1ページ表示',
  spreadOdd: '見開き表示',
  spreadEven: '表紙付き見開き表示',
  captureArea: '範囲を画像として保存',
  zoomToArea: '範囲を拡大',
...
const zhHant: Partial<PdfrxStrings> = {
  ...
  otherColor: '其他…',
  customColor: '自訂顏色',
  saturationBrightness: '飽和度和亮度',
  hue: '色相',
  colorCode: '色彩代碼（#RRGGBB）',
  applyColor: '套用顏色',
  textSize: '文字大小',
  textAlignment: '文字對齊',
  alignLeft: '靠左對齊',
...
const fr: Partial<PdfrxStrings> = {
  ...
  spreadNone: 'Une page',
  spreadOdd: 'Deux pages',
  spreadEven: 'Deux pages avec couverture',
  captureArea: 'Capturer une zone',
  zoomToArea: 'Zoomer sur une zone',
  ...
  copy: 'Copier',
  highlight: 'Surligner',
  textMarkup: 'Annotation de texte',
  textMarkupOptions: "Options d'annotation de texte",
  underline: 'Souligner',
  squiggly: 'Souligner en ondulé',
  strikeout: 'Barrer',
  addLink: 'Ajouter un lien',
  selectAll: 'Tout sélectionner',
  undo: 'Annuler',
  redo: 'Rétablir',
  objectSelection: 'Sélectionner des objets',
  ...
  opacity: 'Opacité',
  thickness: 'Épaisseur',
  deleteAnnotations: 'Supprimer les annotations sélectionnées',
...
const de: Partial<PdfrxStrings> = {
  ...
  spreadNone: 'Einzelseiten',
  spreadOdd: 'Doppelseiten',
  spreadEven: 'Doppelseiten mit Deckblatt',
  captureArea: 'Bereich aufnehmen',
  zoomToArea: 'Auf Bereich zoomen',
  ...
  textMarkupOptions: 'Textmarkierungsoptionen',
  underline: 'Unterstreichen',
  squiggly: 'Wellenförmig unterstreichen',
  strikeout: 'Durchstreichen',
  addLink: 'Link hinzufügen',
  selectAll: 'Alles auswählen',
  undo: 'Rückgängig',
  redo: 'Wiederholen',
  objectSelection: 'Objekte auswählen',
  ...
  deleteAnnotations: 'Ausgewählte Anmerkungen löschen',
