...
wasm-modules-url="https://cdn.jsdelivr.net/npm/@pdfrx/engine@0.22.1/assets/"
...
const viewer = new PdfrxViewer(document.getElementById('container')!, {
  engineOptions: {
  wasmModulesUrl: 'https://cdn.jsdelivr.net/npm/@pdfrx/engine@0.22.1/assets/',
  },
});
