...
The deployable single-viewer collaboration app, persistent relay, and
...
npm run dev:colab    # single-viewer collaboration app + Node.js relay
...
colab script also owns its relay on port 5191; do not start a
